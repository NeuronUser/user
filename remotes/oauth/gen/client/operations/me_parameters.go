...
// WithAccessToken adds the accessToken to the me params
func (o *MeParams) WithAccessToken(accessToken string) *MeParams {
	o.SetAccessToken(accessToken)
	return o
}

// SetAccessToken adds the accessToken to the me params
func (o *MeParams) SetAccessToken(accessToken string) {
