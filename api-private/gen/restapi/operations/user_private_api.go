...
// NewUserPrivateAPI creates a new UserPrivate instance
func NewUserPrivateAPI(spec *loads.Document) *UserPrivateAPI {
...
/*UserPrivateAPI the user private API */
...
func (o *UserPrivateAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *UserPrivateAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *UserPrivateAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *UserPrivateAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *UserPrivateAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *UserPrivateAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *UserPrivateAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the UserPrivateAPI
func (o *UserPrivateAPI) Validate() error {
...
func (o *UserPrivateAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *UserPrivateAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *UserPrivateAPI) Authorizer() runtime.Authorizer {
...
func (o *UserPrivateAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *UserPrivateAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *UserPrivateAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the user private API
func (o *UserPrivateAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *UserPrivateAPI) initHandlerCache() {
...
func (o *UserPrivateAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
